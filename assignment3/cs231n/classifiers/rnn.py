...
class CaptioningRNN:
    ...
    def loss(self, features, captions):
        ...
        if self.cell_type == 'rnn':
          h, rnn_cache = rnn_forward(word_embedding_out, h0, Wx, Wh, b)
        else:
          h, rnn_cache = lstm_forward(word_embedding_out, h0, Wx, Wh, b)
        # (4)
        ...
        # (3)
        if self.cell_type == 'rnn':
          dword_embedding_out, dh0, grads['Wx'], grads['Wh'], grads['b'] = rnn_backward(dh, rnn_cache)
        else:
          dword_embedding_out, dh0, grads['Wx'], grads['Wh'], grads['b'] = lstm_backward(dh, rnn_cache)
        # (2)
    ...
    def sample(self, features, max_length=30):
        ...
        prev_word = np.array([self._start for i in range(N)])
        prev_h = h0
